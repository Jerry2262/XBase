...
set(BRPC_SOURCE_DIR_OVERRIDE "" CACHE PATH
    "When set to an existing brpc source tree, skips download and builds from this directory")
...
if(NOT brpc_FOUND)
    ...
    if("${BRPC_SOURCE_DIR_OVERRIDE}" STREQUAL "")
        _brpc_warn_if_missing_hash("brpc" "${BRPC_SOURCE_URL_HASH}")
    else()
        set(BRPC_SOURCE_DIR "${BRPC_SOURCE_DIR_OVERRIDE}")
    endif()
    ...
    if("${BRPC_SOURCE_DIR_OVERRIDE}" STREQUAL "")
        ...
        FetchContent_Declare(brpc SOURCE_DIR "${BRPC_SOURCE_DIR}")
    endif()
    ...
    if("${BRPC_SOURCE_DIR_OVERRIDE}" STREQUAL "")
        ...
        message(STATUS "Using local brpc sources from ${BRPC_SOURCE_DIR}")
        FetchContent_GetProperties(brpc)
        if(NOT brpc_POPULATED)
            set(brpc_SOURCE_DIR "${BRPC_SOURCE_DIR}")
            set(brpc_POPULATED TRUE)
        endif()
    endif()
