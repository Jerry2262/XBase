...
This produces three mode-specific binaries in `build/`:
...
```shell
$ ./build/kvrocks-all -c kvrocks.conf
```

Use `./build/kvrocks-proxy` or `./build/kvrocks-datanode` when you want the other two modes.
